    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading"> Admission Student</div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="/students">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="news_title" type="text" class="form-control" name="name" value="{{ old('name') }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="news_title" type="text" class="form-control" name="age" value="{{ old('age') }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                <label><input type="radio" name="gender" value="m" {{ old('gender')=="m" ? "checked" : "" }}>Male</label>
